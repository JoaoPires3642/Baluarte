ALTER TABLE checkout_order
    ADD COLUMN IF NOT EXISTS clerk_user_id VARCHAR(120),
    ADD COLUMN IF NOT EXISTS payer_email VARCHAR(160),
    ADD COLUMN IF NOT EXISTS payer_document_type VARCHAR(10),
    ADD COLUMN IF NOT EXISTS payer_document_number VARCHAR(20),
    ADD COLUMN IF NOT EXISTS recipient_name VARCHAR(120),
    ADD COLUMN IF NOT EXISTS shipping_complement VARCHAR(120),
